...
# Furniture type → colour map (previously imported from resplan_utils)
FURNITURE_COLORS = {
    "bed": "#8ecae6", "sofa": "#219ebc", "table": "#ffb703",
    "chair": "#fb8500", "desk": "#023047", "wardrobe": "#606c38",
    "cabinet": "#283618", "shelf": "#dda15e", "tv": "#bc6c25",
    "sink": "#e9d8a6", "toilet": "#94d2bd", "bathtub": "#0a9396",
    "shower": "#005f73", "oven": "#9b2226", "fridge": "#ae2012",
    "washing_machine": "#bb3e03", "dishwasher": "#ca6702",
    "lamp": "#ee9b00", "plant": "#344e41",
}
